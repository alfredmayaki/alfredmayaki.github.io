(function () {
  ...
  if (!elements.searchInput || !elements.searchBtn || !elements.chatbotPopup || 
    ...
    console.error('❌ Critical chatbot elements not found (search/chat core missing)');
    return;
  }
  ...
  function addUserMessage(message) {
    ...
    meta.innerHTML = `<span class="message-author">You</span> ${formatMessageTime(new Date())}`;
  ...
  function addBotBubble(initialText, source = 'claude') {
    const messageDiv = document.createElement('div');
