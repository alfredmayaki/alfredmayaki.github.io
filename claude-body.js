  ...
  try {
    function startTyped() {
      ...
      var strings = isMobile ? [
        'Women\'s Giant Slalom ⛷️',
        'Biathlon Men\'s 20km 🎯',
        'Ice Dance Free Dance ⛸️',
        'Skeleton Women\'s Final 💀',
        'Mixed Team Relay ⛸️',
        'XC Women\'s 4×5km Relay 🎿',
        'Speed Skating Men\'s 5000m ⛸️',
        'Slopestyle Women\'s Final 🎿',
        'Bobsled Two-Man Runs 1-2 🛷',
        'Day 12 — Feb 18 🏅'
      ] : [
        'Women\'s Giant Slalom — Shiffrin vs Brignone on the Tofane ⛷️',
        'Biathlon Men\'s 20km Individual — Bø vs Fillon Maillet at Anterselva 🎯',
        'Figure Skating Ice Dance Free Dance — crowning Olympic champions ⛸️',
        'Skeleton Women\'s Final — Neise defends at Cesana 💀',
        'Short Track Mixed Team Relay Final — chaotic multi-format gold ⛸️',
        'Cross-Country Women\'s 4×5km Relay — Sweden vs Norway at Tesero 🎿',
        'Speed Skating Men\'s 5000m — van der Poel returns? ⛸️',
        'Freestyle Skiing Women\'s Slopestyle Final — Eileen Gu at Livigno 🎿',
        'Bobsled Two-Man Runs 1 & 2 — Friedrich starts title defence 🛷',
        'Day 12 — Wednesday, February 18 🏅'
      ];
      var opts = {
        strings: strings, typeSpeed: 20, backSpeed: 15,
